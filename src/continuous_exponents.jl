...
"""
    ContinuousLEProblem(phase_dynamics!, u0, t_renorm [, p [, t_attr]];
                        <keyword arguments>)

This is a short-hand notation for:

```julia
LEProblem(ODEProblem(...) [, t_attr]; t_renorm=t_renorm ,...)
```

For the list of usable keyword arguments, see [`LEProblem`](@ref).
"""
ContinuousLEProblem(phase_dynamics!, u0, t_renorm::Real, p=nothing,
                    args...; tspan=(0.0, 100.0), kwargs...) =
