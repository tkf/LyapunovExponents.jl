...
OnlineStatsBase._fit!(o::VecMean, x::VectorOb, γ::Float64) = smooth!(o.μs, x, γ)
...
function OnlineStats._fit!(o::VecVariance, x::VectorOb, γ::Float64)
    o.nobs += 1
...
OnlineStatsBase._value(o::VecVariance) =
